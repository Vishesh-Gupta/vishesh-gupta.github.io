...
/**
 * A company named in the bio. Pointing at it (or tabbing to it) swaps the note
 * underneath; the link itself still goes to the company.
 *
...
const Bio: FC = () => {
  ...
  // cursor leaves would make the note unreadable.
  ...
  return (
    <section className="bio-block">
      ...
      <p className="bio">
        ...
        {at('Alpaca')}; previously {at('Monoceros')} and {at('Clear Street')}. I studied
        Computer Science at the University of Waterloo, with a minor in East Asian
        Studies. Mostly I care about backend systems that stay boring under load: clear
        data models, predictable latency, and code someone else can pick up a year later.
        Usually somewhere between timezones.
      </p>
